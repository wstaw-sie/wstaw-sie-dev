...
public class MyProxyOAuth20ServiceImpl extends OAuth20ServiceImpl {
	...
	protected static final String FORCE_AUTHORIZATION_KEY = "max_auth_age";
	protected static final String FORCE_AUTHORIZATION_VALUE = "0";
  ...
  public MyProxyOAuth20ServiceImpl(final DefaultApi20 api, final OAuthConfig config, final int connectTimeout,
  ...
  public Token getAccessToken(final Token requestToken, final Verifier verifier) {
      ...
      if (this.getParameter) {
          ...
          request.addQuerystringParameter(FORCE_AUTHORIZATION_KEY, FORCE_AUTHORIZATION_VALUE); //added by pkalinia
          ...
          request.addBodyParameter(FORCE_AUTHORIZATION_KEY, FORCE_AUTHORIZATION_VALUE);
          if (this.config.hasScope()) {
