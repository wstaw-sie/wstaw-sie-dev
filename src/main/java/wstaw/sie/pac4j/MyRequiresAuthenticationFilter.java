...
* @since 1.0.0
*/
public class MyRequiresAuthenticationFilter extends ClientsConfigFilter {

	private static Logger logger = Logger.getLogger(MyRequiresAuthenticationFilter.class);
...
//      } else {
          ...
          //requestedUrl += "?approval_prompt=force";//max_auth_age=0";
