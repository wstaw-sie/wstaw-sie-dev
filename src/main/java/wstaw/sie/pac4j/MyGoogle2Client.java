...
* @since 1.2.0
*/
public class MyGoogle2Client extends MyBaseOAuth20Client<Google2Profile> {
  ...
  public MyGoogle2Client() {
  }

  public MyGoogle2Client(final String key, final String secret) {
      setKey(key);
      setSecret(secret);
  }

  @Override
  protected MyGoogle2Client newClient() {
      final MyGoogle2Client newClient = new MyGoogle2Client();
